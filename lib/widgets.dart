      ...
      child: Row(children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: isDone? null: Border.all(color: Color(0xFF211551), width: 1.5)
          ),
          child: Image(image: AssetImage("assets/images/check_icon.png"),
          ),
        ),
        Text(text??"{No todo assigned}",
        style: TextStyle(color: isDone? Color(0xFF211551): Color(0xFF868290),
        fontSize: 16.0,
